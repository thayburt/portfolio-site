...
- [ ] Accessibility
  ...
  - [x] Color Contrast (Check gold-on-parchment against WCAG AA for 4.5:1 ratio)
  ...
  - [x] Touch Targets (Ensure social icons are at least 44x44px for mobile)
...
- [ ] Additional effects
  ...
  - [ ] Clip path to add damage to parchment edges?
- [ ] Print media effect
